...
import com.rafael.osworks.api.model.ComentarioInput;
import com.rafael.osworks.api.model.ComentarioModel;
...
public class ComentarioController {
	...
	//Busca uma ordem de serviço a partir do ID, se não encontrar cai na EntidadeNaoEncontrada, caso encontre
	//atribui para ordemServico e busca seus comentarios no return
	@GetMapping
